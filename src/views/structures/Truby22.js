    ...
    return (
        <>
            <div className='d-flex justify-content-between'>
                ...
                <div className='col-4'>
                    <h4><br></br><strong>STORY STRUCTURE Templates</strong></h4>
                    <h5><br></br>&nbsp; &nbsp; <strong>Blockbuster - John Truby's 22 Steps</strong></h5>
                    <p>
                        <p><br></br>
                            Christopher Booker, in <i>The Seven Basic Plot Points</i> (2004), outlines the seven main archetypal narrative arcs. Regardless of genre, all stories fit into one of these archetypes. Click on the pull-down menu to learn more about each plot type:
                        </p>
                        <div class="dropdown mt-3">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                <li><a class="dropdown-item" href="/PlotTemplate">3-Act Structure</a></li>
                                <li><a class="dropdown-item" href="/PlotTemplate">3-Act Structure (Campbell's Hero's Journey)</a></li>
                                <li><a class="dropdown-item" href="/PlotTemplate">3-Act Structure (Vogler's Mythic)</a></li>
                                <li><a class="dropdown-item" href="/PlotTemplate">4-Act Structure</a></li>
                                <li><a class="dropdown-item" href="/PlotTemplate">4-Act Structure (Snyder's Save the Cat)</a></li>
                                <li><a class="dropdown-item" href="/PlotTemplate">Classical 7-Step Structure</a></li>
                                <li><a class="dropdown-item" href="/PlotTemplate">Quest Structure (Propp's Functions)</a></li>
                                <li><a class="dropdown-item" href="/PlotTemplate">Blockbuster Structure (Truby's 22 Steps)</a></li>
                            </ul>
                            </div>
                        </p>
                </div>
                <div className='offset-1 col-7'>
                        ...
                        <br></br>
                        <p>
                            To start, let's choose one of the 7 classic <strong>Narrative Archetypes</strong>:
                        </p>
